					...
					<form class="needs-validation" method="POST" id="detailForm">
						<div class="row g-3">
							...
							<div class="col-12">
								...
								<label> 카테고리 </label>
								<input type="text" class="form-control" id="boardCategory" name="noticeCategory" value="${n.noticeCategory }" readonly>
								<label for="boardTitle" class="form-label">제목</label> 
								<input type="text" class="form-control" id="boardTitle" name="boardTitle" value="${n.boardTitle }" readonly>
							...
							<div class="col-12">
								...
								<div class="input-group">
									<textarea class="form-control" rows="10" name="boardContent" style="resize: none;" readonly>${n.boardContent }</textarea>
								</div>
							</div>
		...
		window.onload=()=>{
			...
			if(upd!=null){
				upd.addEventListener('click',()=>{
					form.action='${contextPath}/updateNotice.adm';
					form.submit();
				});
			}
			...
			document.getElementById('delete').addEventListener('click',()=>{
				form.action='${contextPath}/deleteNotice.adm';
				form.submit();
			});
