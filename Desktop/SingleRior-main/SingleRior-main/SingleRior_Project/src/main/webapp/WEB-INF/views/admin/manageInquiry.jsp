										  ...
										  <div class="modal-dialog">
										    <div class="modal-content">
										      ...
										      <div class="modal-footer">
										        ...
										        <button type="button" class="btn btn-warning" id="showProduct" onclick="location.href='${contextPath}/productDetail.st?productNo=${i.productNo}&boardNo=${i.boardNo}'">상품보기</button>
										      </div>
										    </div>
										  </div>
										</div>
